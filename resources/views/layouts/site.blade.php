...
<!-- Mirrored from landkit.goodthemes.co/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 May 2019 23:58:54 GMT -->
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 col-md-5 col-lg-6 order-md-2">
            ...
            <!-- Image -->
            <img src="{{ asset('assets/img/illustrations/illustration-2.png') }}" class="img-fluid mw-md-150 mw-lg-130 mb-6 mb-md-0" alt="..." data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row align-items-center justify-content-between mb-8 mb-md-11">
          ...
          <div class="col-12 col-md-6 col-lg-5 order-md-1" data-aos="fade-right">
            ...
            <div class="card shadow-light-lg lift lift-lg">
              ...
              <!-- Image -->
              <img src="{{ asset('assets/img/photos/photo-2.jpg') }}" alt="..." class="card-img-top">
          ...
          <div class="col-12 col-md-5 col-lg-6">
            ...
            <div class="w-md-150 w-lg-130 position-relative" data-aos="fade-left">
              ...
              <div class="img-skewed img-skewed-left">
                ...
                <!-- Image -->
                <img src="{{ asset('assets/img/screenshots/desktop/dashkit.jpg') }}" class="screenshot img-fluid img-skewed-item" alt="...">
          ...
          <div class="col-12 col-md-6">
            ...
            <div class="d-md-none" data-flickity='{"fade": true, "imagesLoaded": true, "pageDots": false, "prevNextButtons": false, "asNavFor": "#testimonialsCopy", "draggable": false}'>
              <div class="w-100">
                ...
                <!-- Image -->
                <img src="{{ asset('assets/img/photos/photo-1.jpg') }}" class="img-fluid rounded-top d-md-none" alt="...">

              </div>
              <div class="w-100">
                
                <!-- Image -->
                <img src="{{ asset('assets/img/photos/photo-26.jpg') }}" class="img-fluid rounded-top d-md-none" alt="...">
            ...
            <div class="h-100 d-none d-md-block" data-flickity='{"fade": true, "imagesLoaded": true, "pageDots": false, "prevNextButtons": false, "asNavFor": "#testimonialsCopy", "draggable": false, "setGallerySize": false}'>
              <div class="w-100 h-100">
                ...
                <!-- Image -->
                <div class="w-100 h-100 bg-cover rounded-left" style="background-image: url({{ asset('assets/img/photos/photo-1.jpg') }});">
              ...
              <div class="w-100 h-100">
                ...
                <!-- Image -->
                <div class="w-100 h-100 bg-cover rounded-left" style="background-image: url({{ asset('assets/img/photos/photo-26.jpg') }});">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 col-md-5 col-lg-6 order-md-2">
            ...
            <!-- Image -->
            <img src="{{ asset('assets/img/illustrations/illustration-8.png') }}" alt="..." class="img-fluid mb-6 mb-md-0">
