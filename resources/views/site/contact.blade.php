...
@section('contents')
 ...
 <section class="py-10 py-md-14 overlay overlay-primary overlay-60 bg-cover" style="background-image: url(assets/img/covers/cover-1.jpg); background-position: top;">
      <div class="container">
